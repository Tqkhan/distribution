...
class Orders_model extends MY_Model
{
	...
	public function index_data($scm_code,$first_date,$last_date,$last_start,$start,$end,$user_id=null)
	{
		...
		$this->db->select('product.*,cat.Category_Name, group_concat(s.sale separator ",") as sale, group_concat(s.month separator
        ...
        substring_index(substring_index(concat(group_concat(s.sale separator ","), ",0"), ",", 5), ",", -1)
				 ...
				 ->from('product')
				 ->join('category cat', 'cat.id = product.category_id', 'left')
