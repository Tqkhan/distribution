...
class Finance_model extends MY_Model
{
	...
	{
		$this->db->select('o.distribution_code as dcode, o.id as system-code, "" as one, "" as two, p.scm_product_code as scm-product-code, od.orders as qty, "401" as financecode-hardcoded,od.priority')
				 ->from('orders o')
