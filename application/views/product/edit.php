...
<div id="page-wrapper">
                    ...
                    <div class="panel panel-bd ">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" name="description" type="text" value="<?php  echo $product['description'] ?>" id="example-text-input" placeholder="" >
                                </div>
    ...
    <div class="form-group row">
    <label for="example-text-input" class="col-sm-3 col-form-label">Category Select<span class="required">*</span></label>
    <div class="col-sm-9">
    <select name="category_id" class="form-control" required>
  <option value="">Please Category Team</option>

  <?php foreach($Category as $data_file){ ?>
  <option <?php if($product['category_id']==$data_file['id']) echo "selected"; ?> value="<?php echo $data_file['id']; ?>"><?php echo $data_file['Category_Name']; ?></option>
    <?php } ?>
</select>
    </div>
    </div>
