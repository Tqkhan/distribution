...
<div id="page-wrapper">
    ...
    <div class="col-sm-9">
    <select name="Distribution_code" class="form-control selectpicker" data-live-search="true" required>
  ...
  <option value="<?php echo  ltrim($distribution['dsr_code'], '0'); ?>"    <?php if($orders['distribution_code'] ==  ltrim($distribution['dsr_code'], '0') ){ echo 'selected'; } ?>  ><?php echo $distribution['scm_name']; ?></option>
    ...
    <div class="col-sm-9">
    <select name="Packcode" class="form-control selectpicker" data-live-search="true" required>
