...
<input class="form-control" name="role" type="hidden" value="<?php echo $distributors[0]['role']; ?>" id="example-text-input" placeholder="">
        ...
        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-3 col-form-label">Select DP Price<span class="required">*</span></label>
                                <div class="col-sm-9">
                                    <select class="form-control" name="price_type" type="text" value="" id="example-text-input"  required="">
                                        <option value="">Select DP Price</option>
                                        <option <?php if($distributors[0]['price_type']=="D1") echo "selected";  ?> value="D1">D1</option>
                                        <option <?php if($distributors[0]['price_type']=="D2") echo "selected";  ?> value="D2">D2</option>
                                        <option <?php if($distributors[0]['price_type']=="D3") echo "selected";  ?> value="D3">D3</option>
                                    </select>
                                </div>
                            </div>
